...
namespace Pulumi.Honeycomb
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/martinjt/honeycomb-pulumi-provider";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Honeycomb.version.txt");
    ...
    internal sealed class HoneycombResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public HoneycombResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
